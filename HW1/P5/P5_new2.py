...
#linklist = sc.textFile('../P5/generated_links_medium_sorted.txt', 32)
#titlelist = sc.textFile('../P5/generated_titles_medium_sorted.txt', 32)
#linklist = sc.textFile('../P5/generated_links_large_sorted.txt', 32)
#titlelist = sc.textFile('../P5/generated_titles_large_sorted.txt', 32)
