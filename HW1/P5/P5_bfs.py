...
if __name__ == '__main__':
    ...
    Kevin_Bacon = nameindex.lookup('Kevin_Bacon')[0]
    Harvard_University = nameindex.lookup('Harvard_University')[0]
    
    for (root, dest) in [(Kevin_Bacon, Harvard_University), (Harvard_University, Kevin_Bacon)]:
        ...
        while(True):
            ...
            next_level_rdd = adjacent_graph.filter(lambda p: p[0] in this_level).repartition(10*16) #select the nodes in this level
    ...
    ##        print next_level.value - touched.value
        ...
        if root == Kevin_Bacon:
            print "From Kevin_Bacon to Harvard_University:"
        else:
            print "From Harvard_University to Kevin_Bacon:"
