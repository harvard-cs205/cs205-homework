...
res1 = bfs(graph, 'CAPTAIN AMERICA', sc, num_Partitions, distances=None, stopNode=None)
print "Distance Breakdown from CAPTAIN AMERICA (-1 indicates unreachable)"
print res1.values().countByValue(), '\n'

res1 = bfs(graph, 'MISS THING/MARY', sc, num_Partitions, distances=None, stopNode=None)
print "Distance Breakdown from MISS THING/MARY (-1 indicates unreachable)"
print res1.values().countByValue(), '\n'

res1 = bfs(graph, 'ORWELL', sc, num_Partitions, distances=None, stopNode=None)
