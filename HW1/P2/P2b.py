...
def mandelspark(dim=2000):
	'''Creates coordinate matrix rdd with randomized reshuffle, maps mandelbrot values'''
	vec1   = vec2 = sc.parallelize(xrange(dim),10)
	coords = vec1.cartesian(vec2).repartition(100) # random partitioning of coords
...
figtitle = "Random shuffling (2b)"
figname  = "P2b_hist.png"
