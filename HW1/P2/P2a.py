...
sc = pyspark.SparkContext(appName='SparkApp')


one_dim = sc.parallelize(np.arange(2000), 10)
coords = one_dim.cartesian(one_dim)
...
make_mandelbrot_image_and_hist(coords, 'P2a_hist.png')
