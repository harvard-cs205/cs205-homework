...
if __name__ == '__main__':
    ...
    for N in x:
        ...
        corr.append(t.interval)

    import matplotlib.pyplot as plt
    a = plt.plot(x, corr, label = 'Correlated')
    b = plt.plot(x, uncorr, label = 'Uncorrelated')
   # plt.legend(bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.xlabel('N')
    plt.ylabel('Time(s)')
    plt.legend(loc='upper left')
    plt.title('Correlated and Uncorrelated Medium-grained Performance')
    plt.savefig('medium.svg', format='svg', dpi=800)
