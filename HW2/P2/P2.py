...
if __name__ == '__main__':
    ...
    src = np.random.randint(1000, size=1000).astype(np.int32)
    dest = np.random.randint(1000, size=1000).astype(np.int32)
