...
cdef extern from "AVX.h" nogil:
    ...
    float8 less_than(float8 a, float8 b)     # (a < b) -> 0.0 for False or -1.0 for True
    float8 greater_than(float8 a, float8 b)  # (a > b) -> 0.0 for False or -1.0 for True
    float8 less_eq_than(float8 a, float8 b)  # (a<=b)  -> 0.0 for False or -1.0 for True
