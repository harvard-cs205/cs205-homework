...
if __name__ == '__main__':
    ...
    for ii in [1, 2, 4]:
        with Timer() as t:
            mandelbrot.mandelbrot(in_coords, out_counts, ii, 1024)
        seconds = t.interval

        print("{} Million Complex FMAs in {} seconds, {} million Complex FMAs / second for {} threads".format(out_counts.sum() / 1e6, seconds, (out_counts.sum() / seconds) / 1e6, ii))
