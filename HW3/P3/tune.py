...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        if best_configuration[0] in best_configurations:
            best_configurations[best_configuration[0]].append(best_time)
        else:
            best_configurations[best_configuration[0]] = [best_time]
    for config in best_configurations:
        print "configuration {}: {} times, {} average seconds".format(config, len(best_configurations[config]), np.mean(best_configurations[config]))